!function(e) {
    ...
    e.fn.ajaxSubmit = function(a) {
        ...
        (s = (s = "string" == typeof (o = a.url || this.attr2("action")) ? e.trim(o) : "") || window.location.href || "") && (s = (s.match(/^([^#]+)/) || [])[1]),
        a = e.extend(!0, {
            url: s,
        ...
        var c = {};
        if (this.trigger("form-pre-serialize", [this, a, c]),
        c.veto)
        ...
        var f, m = [], p = this.formToArray(a.semantic, m);
        ...
        a.beforeSubmit && !1 === a.beforeSubmit(p, this, a))
            ...
            this;
        if (this.trigger("form-submit-validate", [p, this, a, c]),
        c.veto)
        ...
        !1 !== a.iframe && (a.iframe || S) ? a.closeKeepAlive ? e.get(a.closeKeepAlive, function() {
            ...
            if (a.extraData) {
                var o = function(t) {
                    var r, n, i = e.param(t, a.traditional).split("&"), o = i.length, s = [];
                    for (r = 0; r < o; r++)
                        i[r] = i[r].replace(/\+/g, " "),
                        n = i[r].split("="),
        ...
        this;
        function k(t) {
            var o, s, c, l, f, p, d, h, v, g, x, b, y = u[0], T = e.Deferred();
            ...
            if ((c = e.extend(!0, {}, e.ajaxSettings, a)).context = c.context || c,
            f = "jqFormIO" + (new Date).getTime(),
            c.iframeTarget ? (g = (p = e(c.iframeTarget)).attr2("name")) ? f = g : p.attr2("name", f) : (p = e('<iframe name="' + f + '" src="' + c.iframeSrc + '" />')).css({
                position: "absolute",
                top: "-1000px",
                left: "-1000px"
            }),
            ...
            if (h.aborted)
                return T.reject(),
                T;
            (v = y.clk) && (g = v.name) && !v.disabled && (c.extraData = c.extraData || {},
            c.extraData[g] = v.value,
            "image" == v.type && (c.extraData[g + ".x"] = y.clk_x,
            ...
            function A() {
                ...
                c.skipEncodingOverride || n && !/post/i.test(n) || u.attr({
                ...
                try {
                    if (c.extraData)
                        for (var s in c.extraData)
                            c.extraData.hasOwnProperty(s) && (e.isPlainObject(c.extraData[s]) && c.extraData[s].hasOwnProperty("name") && c.extraData[s].hasOwnProperty("value") ? o.push(e('<input type="hidden" name="' + c.extraData[s].name + '">').val(c.extraData[s].value).appendTo(y)[0]) : o.push(e('<input type="hidden" name="' + s + '">').val(c.extraData[s]).appendTo(y)[0]));
                    c.iframeTarget || p.appendTo("body"),
                    d.attachEvent ? d.attachEvent("onload", O) : d.addEventListener("load", O, !1),
            ...
            k && D && (c.extraData = c.extraData || {},
            c.extraData[k] = D),
            c.forceSync ? A() : setTimeout(A, 10);
            var L, E, M, F = 50;
            function O(t) {
                if (!h.aborted && !M) {
                    if ((E = S(d)) || (i("cannot access response document"),
                    t = w),
                    t === j && h)
                        return h.abort("timeout"),
                        void T.reject(h, "timeout");
                    if (t == w && h)
                        return h.abort("server abort"),
                    ...
                    if (E && E.location.href != c.iframeSrc || x) {
                        ...
                        try {
                            ...
                            if (i("isXml=" + n),
                            !n && window.opera && (null === E.body || !E.body.innerHTML) && --F)
                            ...
                            ,
                            o && (h.status = Number(o.getAttribute("status")) || h.status,
                            h.statusText = o.getAttribute("statusText") || h.statusText);
                            ...
                            if (u || c.textarea) {
                                ...
                                if (f)
                                    ...
                                    h.statusText = f.getAttribute("statusText") || h.statusText;
                                else if (u) {
                                ...
                                "xml" == s && !h.responseXML && h.responseText && (h.responseXML = X(h.responseText));
                            try {
                                L = _(h, s, c)
                            } catch (e) {
                                a = "parsererror",
                        ...
                        h.aborted && (i("upload aborted"),
                        a = null),
                        h.status && (a = h.status >= 200 && h.status < 300 || 304 === h.status ? "success" : "error"),
                        "success" === a ? (c.success && c.success.call(c.context, L, "success", h),
                        T.resolve(h.responseText, "success", h),
                        l && e.event.trigger("ajaxSuccess", [h, c])) : a && (void 0 === r && (r = h.statusText),
    ...
    e.fn.ajaxForm = function(t) {
        ...
        !t.delegation && 0 === this.length) {
            ...
            return !e.isReady && r.s ? (i("DOM not ready, queuing ajaxForm"),
            e(function() {
        ...
        return t.delegation ? (e(document).off("submit.form-plugin", this.selector, a).off("click.form-plugin", this.selector, n).on("submit.form-plugin", this.selector, t, a).on("click.form-plugin", this.selector, t, n),
        this) : this.ajaxFormUnbind().bind("submit.form-plugin", t, a).bind("click.form-plugin", t, n)
    }
    ,
    ...
    e.fn.formToArray = function(r, a) {
        ...
        if (0 === this.length)
            return n;
        var i, o, s, u, c, l, f, m, p = this[0], d = this.attr("id"), h = r ? p.getElementsByTagName("*") : p.elements;
        if (h && !/MSIE [678]/.test(navigator.userAgent) && (h = e(h).get()),
        d && (i = e(':input[form="' + d + '"]').get()).length && (h = (h || []).concat(i)),
        !h || !h.length)
            return n;
        for (o = 0,
        f = h.length; o < f; o++)
